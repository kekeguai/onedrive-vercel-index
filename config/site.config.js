...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'admin@kekeguai.onmicrosoft.com',
  ...
  protectedRoutes: ['/Z','/study'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:gq170311@gmail.com',
